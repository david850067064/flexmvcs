...
package org.puremvc.core.controller
{
	 ...
	 */
	public class Controller extends FacadeClient implements IController
	{
		...
		public function executeCommand( note : INotification ) : void
		{
			...
			if(commandInstance is IFacadeClient) {
				IFacadeClient(commandInstance).setFacade(facade);
			}
		 ...
		 */
		public function setView( view : IView ) : void
		{
			this.view = view;
		}
